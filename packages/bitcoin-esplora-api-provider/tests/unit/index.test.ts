    ...
    it('should return a transaction', async () => {
      ...
      expect(tx).to.deep.equal({
        ...
        _raw: {
          ...
          hash:
            '69f77ac56edfd27835d8e90a22164bfd63cf7352820ef54c3e40a8358c734944',
          txid:
            'd4b1add055db58343500157a6525a73ceb9c8850f0fb435f1f60071e8cad6540',
          ...
          vin: [
            {
              ...
              scriptSig: {
                asm:
                  '00200153e49dbc4a122f47a87755382629dbdf7ede36e3c1c42b52da81f93ca3e6c3',
                hex:
          ...
          vout: [
            {
              ...
              scriptPubKey: {
                asm:
                  'OP_HASH160 9d3c916e0ebea90c4fc385aed2f8a5bed9595c29 OP_EQUAL',
            ...
            },
            {
              ...
              scriptPubKey: {
                asm:
                  'OP_HASH160 b1ca47496d9e10b431358ab9cb013b6fe0069910 OP_EQUAL',
