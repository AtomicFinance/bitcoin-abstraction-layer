...
function mockEsploraApi() {
  nock('https://blockstream.info:443', { encodedQueryParams: true })
    .get(
      '/testnet/api/tx/d4b1add055db58343500157a6525a73ceb9c8850f0fb435f1f60071e8cad6540',
    )
    .reply(
      200,
      {
        ...
        vin: [
          {
            ...
            prevout: {
              ...
              scriptpubkey_asm:
                'OP_HASH160 OP_PUSHBYTES_20 b1ca47496d9e10b431358ab9cb013b6fe0069910 OP_EQUAL',
              scriptpubkey_type: 'p2sh',
              scriptpubkey_address: '2N9THuntcLXpjnkN5KWAeVMTYMDQyARMzXz',
              value: 976798,
            },
            scriptsig:
              '2200200153e49dbc4a122f47a87755382629dbdf7ede36e3c1c42b52da81f93ca3e6c3',
            scriptsig_asm:
              'OP_PUSHBYTES_34 00200153e49dbc4a122f47a87755382629dbdf7ede36e3c1c42b52da81f93ca3e6c3',
            witness: [
              '',
        ...
        vout: [
          {
            ...
            scriptpubkey_asm:
              'OP_HASH160 OP_PUSHBYTES_20 9d3c916e0ebea90c4fc385aed2f8a5bed9595c29 OP_EQUAL',
            scriptpubkey_type: 'p2sh',
        ...
        status: {
          ...
          block_hash:
            '000000000000015df12c1a2656f4284edc7c8130d68112d5e522b5d22f79b2b0',
  ...
  nock('https://blockstream.info:443', { encodedQueryParams: true })
    .get(
      '/testnet/api/tx/d4b1add055db58343500157a6525a73ceb9c8850f0fb435f1f60071e8cad6540/hex',
    )
    .reply(
      200,
