...
describe('Bitcoin Util', () => {
  ...
  describe('compressPubKey', () => {
    it('should return compressed public key', () => {
      expect(
        ...
        '0393fc49dfd662510bc4d91b4f689d1732ebe4e2d7a67eebc37f76c8d6ec283ef0',
      );
      ...
      expect(
        ...
        '02b1c13be24ddc9f6e816d5469f0874ed965c8bef4084b465f679bf05071b676b8',
      );
    });
  });
  ...
  describe('txHashToObject', () => {
    it('p2pkh', () => {
      ...
      const object = BitcoinUtil.decodeRawTransaction(
        hash,
        BitcoinNetworks.bitcoin_testnet,
      );
      expect(object).to.deep.equal({
        txid:
          '45871d937748494309804357a7ba2924c59a50fede67d25f38547d6f41d51ae3',
        hash:
          '53234f5d0dc8c8bcd7120652151e40a0c959618dfb45ed7d983fdbbc9ce86239',
        version: 2,
        size: 222,
        vsize: 141,
        weight: 561,
        ...
        vin: [
          {
            txid:
              '8d7d1b10adc6c2b5c4f20183d708ee4ab46018c4d649e152f417318846e58211',
            vout: 1,
            scriptSig: {
              asm: '',
              hex: '',
    ...
    it('p2wsh (swap)', () => {
      ...
      expect(object).to.deep.equal({
        txid:
          'bea65e9461a333703c5f4f2c65a3204469a6016857df41b5aff0ecc7269f1cd9',
        hash:
          '0c08692041da03c3bdbb834bf4fb544f9f4b9373ec1f37af8eade84c38d074fa',
        version: 2,
        size: 235,
        vsize: 153,
        weight: 610,
        ...
        vin: [
          {
            txid:
              'eb4fc204f96cab9be1cbefc9a22fce536b1429d7e871839fe61c732cee3f6378',
            vout: 0,
            scriptSig: {
              asm: '',
              hex: '',
        ...
        vout: [
          {
            ...
            scriptPubKey: {
              asm:
                'OP_0 60a5dc9e85a041ef4ff3126f0baca6a9f78940ed6d33f4962629a7ee34d0b9c5',
              hex:
                '002060a5dc9e85a041ef4ff3126f0baca6a9f78940ed6d33f4962629a7ee34d0b9c5',
              reqSigs: 1,
    ...
    it('p2wsh (swap redeem)', () => {
      ...
      expect(object).to.deep.equal({
        txid:
          '5769cc8b37a9c7b3463ed616b5df5210ea705779090e6267f8bfcd8f23560041',
        hash:
          '7dbfcd3a5c93ff371fe86c5e827ce97bb1d276ec38f6f0d09b387dc5a0e693b8',
        version: 2,
        size: 325,
        vsize: 143,
        weight: 571,
