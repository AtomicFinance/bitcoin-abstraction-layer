...
describe('Bitcoin Esplora Api Provider', () => {
  ...
  describe('getUnspentTransactions', () => {
    it('should get unspent transactions', async () => {
      const tx = await provider.getUnspentTransactions([
        '2N4N393YJx9KuZV5D4HMkzHZ7QoFp6tJG1b',
      ]);
      expect(tx).to.deep.equal([
        {
          ...
          status: {
            block_hash:
              '0000000000edbe057f877fdb0de069f636f6a9b03451aa748e8fa77546fcbbf8',
  ...
  describe('getAddressTransactionCounts', () => {
    it('should get tx counts', async () => {
      const tx = await provider.getAddressTransactionCounts([
        '2N4N393YJx9KuZV5D4HMkzHZ7QoFp6tJG1b',
      ]);
