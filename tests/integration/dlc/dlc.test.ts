  ...
  describe('funding with DDK', () => {
    ...
    describe('ddk provider contract id computation', () => {
      it('should compute contract ID matching Rust implementation', async () => {
        ...
        const actualId = computeContractId(fundTxId, outputIndex, temporaryId);

        expect(actualId.toString('hex')).to.equal(expectedId);
      });
    });

    describe('ddk provider DLC input info creation', () => {
      it('should create DLC input info correctly', async () => {
        const dlcOffer = DlcOffer.deserialize(Buffer.from('', 'hex'));
      }):
    });
...
describe('refund tx from serialized dlc messages', () => {
  it('should build broadcastable refund tx hex from offer/accept/sign hexes', async () => {
    const offerHex =
      '';
    const acceptHex =
      '';
    const signHex =
      '';
    ...
    const { dlcTransactions } = await ddk2.dlc.createDlcTxs(
      dlcOffer,
      dlcAccept,
    );
    ...
    const refundTxHex = refundTx.serialize().toString('hex');
    console.log('refund tx hex:', refundTxHex);

    expect(refundTxHex).to.be.a('string').and.not.be.empty;
    expect(Number(refundTx.locktime)).to.equal(dlcOffer.refundLocktime);
  });
});
