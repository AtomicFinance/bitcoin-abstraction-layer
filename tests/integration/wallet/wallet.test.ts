...
describe('wallet provider', () => {
  ...
  describe('getUnusedAddressesBlacklist', () => {
    it('should output used addresses', async () => {
      ...
      const blacklist = await bob.finance.getMethod('getUnusedAddressesBlacklist')()
  ...
  describe('setUnusedAddressesBlacklist', () => {
    it('should import blacklist addresses', async () => {
      ...
      carol.addProvider(new BitcoinJsWalletProvider(network, mnemonic, 'bech32'))
      ...
      const carolBlacklist = await carol.finance.getMethod('getUnusedAddressesBlacklist')()
      ...
      dave.addProvider(new BitcoinJsWalletProvider(network, mnemonic, 'bech32'))
      ...
      await dave.finance.getMethod('setUnusedAddressesBlacklist')(carolBlacklist)
